...
// Definisikan tipe untuk modul yang diimpor secara dinamis.
// Ini memberitahu TypeScript bahwa kita mengharapkan sebuah komponen React default.
type ThemeModule = {
...
export default async function PublicInvitationPage({
  ...
  return <ThemeComponent formData={formData} />;
}
